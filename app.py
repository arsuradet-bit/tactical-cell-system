...
with col2:
    try:
        st.image("logo.png", width=130)  # ดึงรูปโลโก้จาก GitHub
    except Exception:
        pass  # ป้องกันกรณีหาไฟล์รูปไม่เจอ จะได้ไม่แอปพัง
...
# เมื่อมีการกดปุ่ม SCAN ให้ดึงข้อมูลจาก Cloud SQL โดยตรงด้วย SQL Query
if scan_clicked:
...
# กำหนดพิกัดกลางเริ่มต้น (สงขลา / หาดใหญ่)
